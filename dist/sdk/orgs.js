...
export function createOrgsSDK(supabase, eventIds) {
    return {
        ...
        async getDetails(orgId, eventId) {
            assertEventAllowed(eventId, eventIds);
        ...
        async getTicketCount(eventId, orgId) {
            assertEventAllowed(eventId, eventIds);
        ...
        async getTicketOrders(orgId, eventId) {
            assertEventAllowed(eventId, eventIds);
            const { data, error } = await supabase
                .from("ticket_orders")
        ...
        async removeStudent(studentEventId) {
            const { data, error } = await supabase
                .from("student_events")
